...
// LENGTH OF A STRING
console.assert(getLength("word") === 4); //str === 'word'
console.assert(getLength('this is a really short string') === 29); // str === 'really short string'
console.assert(getLength('Lorem ipsum dolor sit amet, consectetur adipisicing elit.') === 57); //str === Lorem
